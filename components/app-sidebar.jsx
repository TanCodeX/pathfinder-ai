        ...
        <div className={cn(
          ...
          {(isOpen || isMobile) && (
            ...
            >
              ...
              <span className="text-[10px] font-bold text-muted-foreground truncate uppercase tracking-widest mt-0.5">{user?.publicMetadata?.plan ? `${user.publicMetadata.plan} Member`.toUpperCase() : 'Free Member'}</span>
            </motion.div>
          )}
        </div>
      </div>
