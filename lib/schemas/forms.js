...
export const jobApplicationSchema = z.object({
  ...
  status: z.enum(["Wishlist", "Applied", "Interviewing", "Offer Received", "Archived"]).default("Wishlist"),
...
export const jobApplicationUpdateStatusSchema = z.object({
  ...
  status: z.enum(["Wishlist", "Applied", "Interviewing", "Offer Received", "Archived"]),
});
